        ...
        <div class="card-body">
          <form @submit.prevent="saveData" class="forms-sample">
            <div class="form-group">
              ...
              <input v-model="datas.nama" type="text" autofocus class="form-control" :class="{ 'is-invalid': invalid }" name="nama" placeholder="Nama Mahasiswa" />
            ...
            <div class="form-group">
              ...
              <input v-model="datas.nim" type="text" autofocus class="form-control" :class="{ 'is-invalid': invalid }" name="nim" placeholder="NIM" />
...
export default {
  ...
  methods: {
    saveData: function (e) {
      ...
      if (this.$route.params.id) {
        axios
          .put("/api/jurusan/" + this.$route.params.id, this.datas)
          .then((response) => {
